...
Lab_orig = c(
  ...
  "ICM14B" ,
  "FAA505",
  "FAI515", "Absorção Atômica - HBr, Br",
  "Medidor de Íon Específico - Semiquantitativa",
  "Absorção Atômica - HNO3, HF, HCl, HClO4",
  "Absorção Atômica - Sublimação KI",
  ...
  "Medidor de Íon Específico", "Cromatografia - Semiquantitativa",
  "ICP-MS - Digestão Multiácida",
  "Fusão de 50g - Fire Assay",
  "ICP-MS - Digestão Água Régia",
  "Eletrodo de Íon Específico F - Fusão e Dissolução","1F","NA",
  "ICM14B", "FAA505", "FAI515", "Água régia_ICP-MS + ICP-AES",
  "SCR33","ICM40B", "ICP-AES", "AAS19V")
Lab = c("AA", "AA", "AA", "COL", "AA", "AA", "EE", "AA", "IE",
        "IE", "EE", "EE", "AA", "AA", "AA", "AA", "IE", "AA",
        "AA", "CR", "EE", "FA", "EE", "IE", "EE", "EE", "EE",
        "FA", "FA", "AA", "IE","AA", "AA","AA","AA","EE",
        "IE", "CR","EE", "FA","EE", "IE", "EE", "EE", "EE", "FA",
        "FA", "EE", "GV", "EE", "EE", "AA" )
